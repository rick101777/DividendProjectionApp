...
from market.constants import TOTAL_LIQUID_ASSETS


class GenerateDividends:

    @staticmethod
    def dividend_calculation(companies_df: DataFrame, total_liquid_assets=None) -> DataFrame:
        ...
        dividends_df["Number of Shares"] = (TOTAL_LIQUID_ASSETS if total_liquid_assets is None
                                            else total_liquid_assets) / companies_df["Price Per Share"]
